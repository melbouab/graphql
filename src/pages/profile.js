    ...
    try {
          ...
          <section class="profile-section" id="section-xp">
            ...
            <div class="user-info">
              <div class="info-card highlight">
                ...
                <span class="card-value">${formatXpValue(totalXp)}</span>
              </div>
              <div class="info-card">
              ...
              <div class="info-card">
                ...
                <span class="card-value">
                  ${
                    nestedTx.length > 0
                      ? formatXpValue(nestedTx[0].amount) +
                        " — " +
                        (nestedTx[0].object?.name || "?")
                      : "N/A"
                  }
                </span>
              </div>
          ...
          <section class="profile-section" id="section-audits">
            ...
            <div class="user-info">
              ...
              <div class="info-card">
                ...
                <span class="card-value" style="color:var(--success);">${formatXpValue(user.totalUp)} </span>
              </div>
              <div class="info-card">
                <span class="card-label">Audits Received</span>
                <span class="card-value" style="color:var(--danger);">${formatXpValue(user.totalDown)} </span>
              </div>
            </div>
          </section>
      ...
      return `
        <div style="display:flex;flex-direction:column;align-items:center;
          ...
          <p style="color:var(--text-muted);font-size:1.1rem;">Redirecting to login...</p>
        </div>
      `;
    }
  }
